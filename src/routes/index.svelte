...
<style lang="scss">
    :global(body) {
        margin: 0;
        // background: linear-gradient(#00c2ff00, #00c2ff00, #00c2ff00, rgba(148, 41, 255, 0.53));
    }
    ...
    .how-it-works {
        ...
        background-color: #9cb4e7; //linear-gradient(#ccdce8, #bcc8ec);
        ...
        .content {
            ...
            .cards {
                ...
                border-radius: 12px;
                overflow: hidden;
                box-shadow: 0 0 2px 1px #4d4d4daa;

                .step-card {
                    transition: all 0.3s;
                    // background: linear-gradient(#ac69f7, #6e2bb6);
    ...
    .sign-up {
        ...
        background-image: url(data:image/png;base64,);
        background-color: #8ba5df; //linear-gradient(#ccdce8, #bcc8ec);

...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-b1408b38.js", "src/routes/index.svelte": "pages/index.svelte-7c194a3a.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-a8cd1609.css", "assets/pages/index.svelte-4b377fc0.css"],
      js: ["start-b1408b38.js", "chunks/vendor-b8dc1a62.js", "pages/index.svelte-7c194a3a.js"]
    }
  ]
};
...
var index_svelte = "h1.svelte-vf4q0s.svelte-vf4q0s,h3.svelte-vf4q0s.svelte-vf4q0s,h5.svelte-vf4q0s.svelte-vf4q0s,p.svelte-vf4q0s.svelte-vf4q0s{color:white}body{margin:0;height:100vh;background:linear-gradient(235.71deg, #400a84 7.8%, #1b0a30 92.44%)}main.svelte-vf4q0s.svelte-vf4q0s{text-align:center;padding:1em;margin:auto}.email-form.svelte-vf4q0s.svelte-vf4q0s{width:459px;height:171px;margin:auto;display:flex;flex-direction:column;align-items:flex-start;padding:24px;background:linear-gradient(0deg, #040a11, #040a11), #0352af;box-shadow:0px 4px 4px rgba(0, 0, 0, 0.25);border-radius:8px}.email-form.svelte-vf4q0s h5.svelte-vf4q0s{margin:0}.email-form.svelte-vf4q0s input.svelte-vf4q0s{height:48px;border:none;background:rgba(142, 145, 148, 0.1);border-radius:4px;color:white}.email-form.svelte-vf4q0s button.svelte-vf4q0s{height:48px;border:none;background:#400a84;border-radius:4px;padding:8px;color:white}.email-form.svelte-vf4q0s p.svelte-vf4q0s{font-size:12px;font-weight:300}";
const css = {
  code: "h1.svelte-vf4q0s.svelte-vf4q0s,h3.svelte-vf4q0s.svelte-vf4q0s,h5.svelte-vf4q0s.svelte-vf4q0s,p.svelte-vf4q0s.svelte-vf4q0s{color:white}body{margin:0;height:100vh;background:linear-gradient(235.71deg, #400a84 7.8%, #1b0a30 92.44%)}main.svelte-vf4q0s.svelte-vf4q0s{text-align:center;padding:1em;margin:auto}.email-form.svelte-vf4q0s.svelte-vf4q0s{width:459px;height:171px;margin:auto;display:flex;flex-direction:column;align-items:flex-start;padding:24px;background:linear-gradient(0deg, #040a11, #040a11), #0352af;box-shadow:0px 4px 4px rgba(0, 0, 0, 0.25);border-radius:8px}.email-form.svelte-vf4q0s h5.svelte-vf4q0s{margin:0}.email-form.svelte-vf4q0s input.svelte-vf4q0s{height:48px;border:none;background:rgba(142, 145, 148, 0.1);border-radius:4px;color:white}.email-form.svelte-vf4q0s button.svelte-vf4q0s{height:48px;border:none;background:#400a84;border-radius:4px;padding:8px;color:white}.email-form.svelte-vf4q0s p.svelte-vf4q0s{font-size:12px;font-weight:300}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script lang=\\"ts\\"></script>\\n\\n<main>\\n    <h1>Block Parties</h1>\\n\\n    <div>\\n        <h3>A <em>Revolution</em> in Investing</h3>\\n        <p>Leveraging the blockchain to make investing as <em>safe</em>, <em>easy</em>, and <em>social</em> as ever.</p>\\n    </div>\\n\\n    <div class=\\"email-form\\">\\n        <h5>Reserve your seat in the limited access beta</h5>\\n        <div>\\n            <input type=\\"email\\" />\\n            <button>Submit</button>\\n        </div>\\n        <p>We won't use your email for anything other than letting you know when the beta opens.</p>\\n    </div>\\n</main>\\n\\n<style lang=\\"scss\\">h1,\\nh3,\\nh5,\\np {\\n  color: white;\\n}\\n\\n:global(body) {\\n  margin: 0;\\n  height: 100vh;\\n  background: linear-gradient(235.71deg, #400a84 7.8%, #1b0a30 92.44%);\\n}\\n\\nmain {\\n  text-align: center;\\n  padding: 1em;\\n  margin: auto;\\n}\\n\\n.email-form {\\n  width: 459px;\\n  height: 171px;\\n  margin: auto;\\n  display: flex;\\n  flex-direction: column;\\n  align-items: flex-start;\\n  padding: 24px;\\n  background: linear-gradient(0deg, #040a11, #040a11), #0352af;\\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\\n  border-radius: 8px;\\n}\\n.email-form h5 {\\n  margin: 0;\\n}\\n.email-form input {\\n  height: 48px;\\n  border: none;\\n  background: rgba(142, 145, 148, 0.1);\\n  border-radius: 4px;\\n  color: white;\\n}\\n.email-form button {\\n  height: 48px;\\n  border: none;\\n  background: #400a84;\\n  border-radius: 4px;\\n  padding: 8px;\\n  color: white;\\n}\\n.email-form p {\\n  font-size: 12px;\\n  font-weight: 300;\\n}</style>\\n"],"names":[],"mappings":"AAoBmB,8BAAE,CACrB,8BAAE,CACF,8BAAE,CACF,CAAC,4BAAC,CAAC,AACD,KAAK,CAAE,KAAK,AACd,CAAC,AAEO,IAAI,AAAE,CAAC,AACb,MAAM,CAAE,CAAC,CACT,MAAM,CAAE,KAAK,CACb,UAAU,CAAE,gBAAgB,SAAS,CAAC,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,OAAO,CAAC,MAAM,CAAC,AACtE,CAAC,AAED,IAAI,4BAAC,CAAC,AACJ,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,IAAI,AACd,CAAC,AAED,WAAW,4BAAC,CAAC,AACX,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,UAAU,CACvB,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,gBAAgB,IAAI,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CAAC,CAAC,OAAO,CAC5D,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAC3C,aAAa,CAAE,GAAG,AACpB,CAAC,AACD,yBAAW,CAAC,EAAE,cAAC,CAAC,AACd,MAAM,CAAE,CAAC,AACX,CAAC,AACD,yBAAW,CAAC,KAAK,cAAC,CAAC,AACjB,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACpC,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,KAAK,AACd,CAAC,AACD,yBAAW,CAAC,MAAM,cAAC,CAAC,AAClB,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,OAAO,CACnB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GAAG,CACZ,KAAK,CAAE,KAAK,AACd,CAAC,AACD,yBAAW,CAAC,CAAC,cAAC,CAAC,AACb,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AAClB,CAAC"}`
};
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-vf4q0s"}"><h1 class="${"svelte-vf4q0s"}">Block Parties</h1>

    <div><h3 class="${"svelte-vf4q0s"}">A <em>Revolution</em> in Investing</h3>
        <p class="${"svelte-vf4q0s"}">Leveraging the blockchain to make investing as <em>safe</em>, <em>easy</em>, and <em>social</em> as ever.</p></div>

    <div class="${"email-form svelte-vf4q0s"}"><h5 class="${"svelte-vf4q0s"}">Reserve your seat in the limited access beta</h5>
        <div><input type="${"email"}" class="${"svelte-vf4q0s"}">
            <button class="${"svelte-vf4q0s"}">Submit</button></div>
        <p class="${"svelte-vf4q0s"}">We won&#39;t use your email for anything other than letting you know when the beta opens.</p></div>
</main>`;
});

...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-7872ac24.js", "src/routes/index.svelte": "pages/index.svelte-d8017c6c.js", "src/routes/clubs.svelte": "pages/clubs.svelte-101b0049.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      js: ["start-7872ac24.js", "chunks/vendor-c56092ef.js", "pages/index.svelte-d8017c6c.js"]
    },
    {
      type: "page",
      pattern: /^\/clubs\/?$/,
      ...
      js: ["start-7872ac24.js", "chunks/vendor-c56092ef.js", "pages/clubs.svelte-101b0049.js"]
    }
  ]
};
...
<main class="${"svelte-qgj3c0"}"><h1>Block Parties</h1>
    ...
    <div class="${"email-form svelte-qgj3c0"}"><h5 class="${"svelte-qgj3c0"}">Reserve your seat in the limited access beta</h5>
        ...
        <br>
        <p class="${"svelte-qgj3c0"}">Wanna chat? <a href="${"https://discord.gg/KN4YqV5Hqw"}">Join our Discord</a></p></div>
</main>`;
});
